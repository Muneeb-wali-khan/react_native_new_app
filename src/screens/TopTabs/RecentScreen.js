...
import { useGetNewsTeslaQuery } from '../../store/features/ApiCalls';

const RecentScreen = () => {
  const navigation = useNavigation();
  const {data: newsData, isLoading} = useGetNewsTeslaQuery()
  const bgcover =
    'https://www.qatar-tribune.com/watanqatartribune/uploads/images/2022/12/28/61736.jpg';
        ...
        <View
          ...
          <View style={{maxWidth: 200}}>
            <Text style={{fontSize: 25, fontWeight: '900', color: WHITE_BG}}>
              Tesla launched a new car model in market{' '}
              <View>
                <Text
                  style={{
                    fontSize: 12,
