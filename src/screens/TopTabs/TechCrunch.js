...
import { useGetNewsTechQuery } from '../../store/features/ApiCalls';
import Loader from '../../components/Loader';

const TechCrunch = () => {
  const navigation = useNavigation();
  const {data: newsData, isLoading} = useGetNewsTechQuery()
  const bgcover =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSU5TY9xWpxgpCDRLLibnrp87P4GI5K4YF2Ng&s';
        ...
        <View
          ...
          <View style={{maxWidth: 200}}>
            <Text style={{fontSize: 25, fontWeight: '900', color: WHITE_BG}}>
              Ai a big problem for human beings modern era{' '}
              <View>
                <Text
                  style={{
                    fontSize: 12,
